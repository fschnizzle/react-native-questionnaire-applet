...
type SubCategory1Props = {
  navigation: StackNavigationProp<RootStackParamList, 'SubCategory1'>;
};
...
const SubCategory1: React.FC<SubCategory1Props> = ({ navigation }) => {
  ...
  const [checkboxSelection, setCheckboxSelection] = useState<string[]>(formData.subCategory1.checkboxSelection);
  const [sliderValue, setSliderValue] = useState<number>(formData.subCategory1.sliderValue);
